...
public class OurTeamActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			webView = (WebView) findViewById(R.id.webOur);
			pgrShowAcademicSync = (ProgressBar) findViewById(R.id.pgrShowOur);

			String url1 = "" + AllKeys.PANEL_GENERIC
					+ "page.aspx?type=team&clientid=" + AllKeys.CLIENT_ID
