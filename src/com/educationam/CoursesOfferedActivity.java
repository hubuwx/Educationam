...
public class CoursesOfferedActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			webView = (WebView) findViewById(R.id.webCourses);
			pgrShowAcademicSync = (ProgressBar) findViewById(R.id.pgrShowCourses);

			String url1 = "" + AllKeys.PANEL_GENERIC
					+ "page.aspx?type=course&clientid=" + AllKeys.CLIENT_ID
